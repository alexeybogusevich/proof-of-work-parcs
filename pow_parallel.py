...
class Solver:
    ...
    def solve(self):
        ...
        text, level, nonces_per_worker = self.read_input()
        nonce_start = 0
        ...
        while not found:
            ...
            nonce_start += nonces_per_worker * len(self.workers)
            mapped = []
        ...
        found_by_thread = (nonce // nonces_per_worker + 1) % len(self.workers)
        output = Solver.get_proof_of_work_output(level, nonce, hasht, nonce, elapsed_time, found_by_thread, len(self.workers))
    ...
    def read_input(self):
        ...
        f.close()
        return text, level, nonces_per_worker
